...
@bot.message_handler(commands=['adminyap'])
def make_admin(message):
    # Yanıtlanan mesajı alın
    replied_message = message.reply_to_message

   
    yetki_menusu = types.InlineKeyboardMarkup()
    keyboard.row(
        types.InlineKeyboardButton("Bilgiyi Değiştirme", callback_data="can_change_info"),
        types.InlineKeyboardButton("Mesajları Silme", callback_data="can_delete_messages")
    )
    keyboard.row(
        types.InlineKeyboardButton("Kullanıcı Davet Etme", callback_data="can_invite_users"),
        types.InlineKeyboardButton("Üyeleri Kısıtlama", callback_data="can_restrict_members")
    )
    keyboard.row(
        types.InlineKeyboardButton("Mesajları Sabitleme", callback_data="can_pin_messages")
    )


    bot.send_message(
        chat_id=message.chat.id,
        text="Bu Kardeşin Yetkileri Ne Olsun ?",
        reply_markup=yetki_menusu
    )
...
def handle_callback(call):
    ...
    bot.promote_chat_member(
        ...
        can_change_info="can_change_info" in call.data,
        can_delete_messages="can_delete_messages" in call.data,
        can_invite_users="can_invite_users" in call.data,
        can_restrict_members="can_restrict_members" in call.data,
        can_pin_messages="can_pin_messages" in call.data,
    ...
    bot.send_message(
        chat_id=call.message.chat.id,
        text=f"{call.message.reply_to_message.from_user.first_name} yönetici ilan edildi !"
    )
